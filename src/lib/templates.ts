export type HeightmapTemplateId =
  | "volcano"
  | "highIsland"
  | "lowIsland"
  | "continents"
...
export type PrecreatedHeightmapId =
  | "africa-centric"
  | "arabia"
  | "atlantics"
  | "britain"
...
export type HeightmapId = HeightmapTemplateId | PrecreatedHeightmapId;
...
export const heightmapTemplates: Record<HeightmapTemplateId, HeightmapTemplate> = {
...
export const precreatedHeightmaps: Record<PrecreatedHeightmapId, PrecreatedHeightmap> = {
